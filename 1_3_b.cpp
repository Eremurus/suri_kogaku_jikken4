...
int main(){
    vector<double> x;
    double a = -1.0, b=1.0;
    double real_ans = (exp(5.0)-exp(-5.0)) / 5.0;

    ofstream tyuten_file, daikei_file, simpson_file;
    string filename_tyuten = "1_3_b_tyuten.txt";
    string filename_daikei = "1_3_b_daikei.txt";
    string filename_simpson = "1_3_b_simpson.txt";
